...
#' Plot individual Class A associations across PSets
#' 
plot_ClassA_indivPlot <- function(pair) {
    ...
    png(paste0("DrugResponse/results/figures/ClassA/indivPlots/", pair, ".png"), width=160, height=125, units='mm', res = 600, pointsize=80)
