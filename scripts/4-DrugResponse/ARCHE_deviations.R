# try scoring drug response to deviation scores instead of zscores
...
cells_20k <- get_arche_devs("cells", "20k", c_meta)
cells_50k <- get_arche_devs("cells", "50k", c_meta)
cells_all <- get_arche_devs("cells", "all", c_meta)
...
save(pc_20k, pc_50k, pc_all, pcnorm_20k, pcnorm_50k, pcnorm_all,
     file = "data/results/data/4-DrugResponse/CCLs/ARCHE_CCLs_deviations_associations.RData")
