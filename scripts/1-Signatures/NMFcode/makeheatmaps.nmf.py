...
decomp.matrix_input_name('data/results/data/Misc/Preclin_TNBC/'+str(rank)+'Rank_NNDSVD_Basis.npy','data/results/data/Misc/Preclin_TNBC/'+str(rank)+'Rank_NNDSVD_Mixture.npy')
...
A = pd.read_table("data/rawdata/misc/preclin_tnbc.matrix", header=0, index_col=0)
